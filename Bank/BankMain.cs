    ...
    public class BankMain
    {
        ...
        public static void Main(String[] args)
        {
            ...
            */
            ...
            //Exerice 10 inheritence

            BusinessCustomer bc1 = new BusinessCustomer("Tom", "Melbouren 199", "ABNSomthing");
            bc1.showBusinessCustomerDetails();

            PersonalCustomer pc1 = new PersonalCustomer("Tom", "Melbouren 199", "TFNSomthing", DateTime.Now);
            pc1.showBusinessCustomerDetails();
